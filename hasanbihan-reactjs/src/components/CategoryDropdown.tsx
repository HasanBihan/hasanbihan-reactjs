...
const CategoryDropdown : React.FC<IProps> = ({getSelectedCategory}) => {
    
  const [selected, setSelected] = useState<any>({id:"0","name":"All Categories"})
                    ...
                    <Listbox.Option
                      ...
                      className={({ active }) =>
                        `relative cursor-default select-none py-2 pl-10 pr-4 ${
                          active ? 'bg-indigo-100 text-teal-900' : 'text-gray-900'
                        }`
                      }
                      value={category}
                    >
